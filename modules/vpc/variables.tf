...
variable "tgw_subnets" {
  description = "A list of tgw subnets"
  type        = list(string)
  default     = []
}
...
# variable "one_route_table_per_az" {
#   description = "Should be true if you one route table per availability zone. Requires `var.azs` to be set."
#   type        = bool
#   default     = null
# }

variable "one_public_route_table_per_az" {
  description = "Should be true if you want one public route table per availability zone. Requires `var.azs` to be set. Do not set "
  type        = bool
  default     = true
}

variable "one_private_route_table_per_az" {
  description = "Should be true if you want one private route table per availability zone. Requires `var.azs` to be set."
  type        = bool
  default     = false
}

variable "one_firewall_route_table_per_az" {
  description = "Should be true if you want one firewall route table per availability zone. Requires `var.azs` to be set."
  type        = bool
  default     = false
}

variable "one_database_route_table_per_az" {
  description = "Should be true if you want one database route table per availability zone. Requires `var.azs` to be set."
  type        = bool
  default     = false
}

variable "one_tgw_route_table_per_az" {
  description = "Should be true if you want one tgw route table per availability zone. Requires `var.azs` to be set."
  type        = bool
  default     = false
}

variable "tgw" {
  description = "Should be true if you one tgw route table per availability zone. Requires `var.azs` to be set."
  type        = bool
  default     = true
}
...
variable "propagate_tgw_route_tables_vgw" {
...
# TODO: statically set the variable type (right now it's ommited for simplicity)
...
variable "firewall_route_table_routes" {
  description = "Configuration block of routes. See https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/default_route_table#route"
  # type        = list(map(string))
  default = []
}
...
variable "igw_route_table_routes" {
  description = "Configuration block of routes. See https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/default_route_table#route"
  # type        = list(map(string))
  default = []
}
...
variable "igw_route_table_tags" {
  description = "Additional tags for the igw route table"
  type        = map(string)
  default     = {}
}
...
variable "create_igw_rt" {
  description = "Should a dedicated IGW route table be created and associated?"
  type        = bool
  default     = false
}
